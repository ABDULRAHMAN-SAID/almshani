...
const DIFF={easy:{noise:0.28,pw:[5.6,9.4],blind:0.45},mid:{noise:0.034,pw:[8.8,12.0],blind:0.13,sim:4},hard:{noise:0.0006,pw:[10.4,13.4],blind:0,sim:20,zc:1,fine:1}};
...
ck('جدول الصعوبة في اللعبة يحمل sim للمتوسّط والصعب',tbl.length===3&&/sim:4/.test(tbl[1])&&/sim:20/.test(tbl[2]),tbl.join(' | '));
