...
module.exports=[
 ...
 ['sr-limits',R("push('partyScr');push('srSetup');PT.n=4;srLimits()")],
 ['sr-spin',R("push('partyScr');push('srSetup');PT.n=4;srStart()")],
 ['sr-card',R("push('partyScr');push('srSetup');PT.n=4;srStart();PT.spin=0;srAsk()")],
 ['sr-end',R("push('partyScr');push('srSetup');PT.n=4;srStart();PT.ans=[3,1,2,0];PT.skip=[0,2,1,3];srEnd()")],
