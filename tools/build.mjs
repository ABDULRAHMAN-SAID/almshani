...
const MODULES = ['src/progression/rank.js', 'src/network/net.js', 'src/audio/sfx.js', 'src/audio/voice.js', 'src/audio/music.js', 'src/ui/icons.js', 'src/economy/catalog.js', 'src/economy/billing.js', 'src/navigation/router.js', 'src/games/carrom/physics.js', 'src/vendor/three-global.js', 'src/games/stage3d/stage3d.js'];
