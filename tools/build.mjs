...
const MODULES = ['src/progression/rank.js', 'src/network/net.js', 'src/audio/sfx.js', 'src/economy/catalog.js', 'src/economy/billing.js', 'src/navigation/router.js', 'src/games/carrom/physics.js'];
