...
(async()=>{
 ...
 try{
  ...
  check('ترحيب برمز وهوية ثابتة وثلاث رتب (لعبةٌ لكلّ رتبة)',wa.t==='welcome'&&wa.token.length===32&&/^p[0-9a-f]+$/.test(wa.id)&&Object.keys(wa.ranks).length===3,JSON.stringify(wa).slice(0,200));
