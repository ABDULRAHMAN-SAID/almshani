...
- «متجر» اللعبة يعرض أسعارًا بالدولار وزرّ «إتمام الشراء التجريبي» — قبل الرفع يجب ربطه بالشراء داخل التطبيق (StoreKit / Play Billing) أو إخفاؤه، وإلا رُفض التطبيق.
