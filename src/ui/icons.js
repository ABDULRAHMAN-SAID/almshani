...
var ICO2=(function(){
 ...
 I.check=S('M4.8 12.6 L9.6 17.4 L19.2 6.8',B('green'),3);
 I.cross=S('M6.6 6.6 L17.4 17.4 M17.4 6.6 L6.6 17.4',B('red'),3);
 I.info=OC(12,12,9.2,B('blue'),2)+CC(12,7.5,1.4,B('blue'))+RC(10.7,10.4,2.6,7.1,1.3,B('blue'));
 I.plus=S('M12 5.2 V18.8 M5.2 12 H18.8',B('green'),3);
 ...
 I.export=S('M12 15.2 V4.4 M7.6 8.8 L12 4.4 L16.4 8.8',B('blue'),2.6)+S('M4.8 14.4 V19.2 H19.2 V14.4',B('blue'),2.6);
 ...
 I.list=CC(18.6,7.2,1.5,B('blue'))+CC(18.6,12,1.5,B('blue'))+CC(18.6,16.8,1.5,B('blue'))+
